...
const updateItem = (array, arrayItems) => {
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  arrayItems.forEach((e) => {
    if (e.bool === false) {
      _jsmodules_selectors_js__WEBPACK_IMPORTED_MODULE_5__["default"].insertAdjacentHTML('beforeend',
  ...
  const checkId = _jsmodules_selectors_js__WEBPACK_IMPORTED_MODULE_5__["default"].querySelectorAll('input[type="checkbox"]');
  (0,_jsmodules_update_js__WEBPACK_IMPORTED_MODULE_3__.updateItem)(checkId, arrayItems);
});
})();
